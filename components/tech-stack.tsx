      ...
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-2 border-l border-t border-border sm:grid-cols-4 lg:grid-cols-8">
          {techStack.map((tech) => {
            ...
            return (
              <div key={tech.name} className="group flex min-h-28 flex-col items-start justify-between border-b border-r border-border bg-[#fdfdfd] p-4 transition-colors hover:bg-muted">
