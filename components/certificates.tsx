      ...
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
        ...
        <div className="mt-14 grid gap-4 md:grid-cols-3">
          {certificates.map((certificate, index) => (
            <Reveal as="article" key={certificate.id} delay={index * 0.08} y={16} className="group rounded-sm border border-border bg-white p-6 transition-colors hover:bg-muted">
